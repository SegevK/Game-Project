...
#pragma warning restore 649
        ...
        private void ValidateRotationRestriction()    //used so players wont rotate when loocking down or up 
        {
        ...
        {
            if (PauseMenu.IsOn)       //TO DO -- CHECK IF THERE IS A MORE EFFICENT WAY TO SET VELOCITY SO IT WONT BE DONE EVERY FRAME WHILE IN THE PAUSE MENUE
            {
        ...
        private void RotateCameraAndCharacter()   //used for looking around
        {
        ...
        private void MoveCharacter()  //moves the character around
        {
        ...
        private void Jump()
        {
            ...
            _isGrounded = false;
            _rigidbody.AddForce(Vector3.up * jumpForce, ForceMode.Impulse);    //sends the player into the air with force,causing the jump(the de-acceleration and falling after jump is handled by the mass and gravity)
        }
